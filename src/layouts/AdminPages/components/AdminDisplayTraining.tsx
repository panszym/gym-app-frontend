      ...
      <div className="row g-0">
          ...
          <div className="card-body">
            <h6 className="cart-title">
              {DateTimeFormat.formatDateString(
                props.training.dateTime.toString()
              )}
            </h6>
            <h4>{props.training.name}</h4>
            <h5 className="card-text">{props.training.description}</h5>
          </div>
        </div>
        <div className="col-md-4 ">
          <div className="card-body d-wrap">
            <div className="container d-flex justify-content-center align-items-center">
              <Link
                to={`/admin/training/detail/${props.training.trainingCode}`}
                type="button"
            ...
            <div className="contrainer d-flex justify-content-center align-items-center">
              <p>Status: </p>{" "}
              {props.training.status === "ACTIVE" ? (
                <p className="text-success mx-1">
                  {props.training ? props.training.status : "N/A"}
                </p>
              ) : (
