...
export const DisplayClientTraining: React.FC<{ training: TrainingModel }> = (
  props
) => {
  return (
      ...
      <div className="row g-0">
        ...
        <div className="col-md-4 ">
            <div className="card-body d-wrap">
                <div className="container d-flex justify-content-center align-items-center">
                <Link to={`/training/client/detail/${props.training.trainingCode}`} type="button" className="btn btn-sm btn-primary mb-2">Details</Link>
                </div>
